...
import { AntdFormPropTypes, RoutingStorePropTypes, UserStorePropTypes } from '../../types/PropTypeValues';
...
const wrappedComponent = Form.create({
  onValuesChange: (props, changedValues, allValues) => console.info(changedValues, allValues),
})(Registration);
