...
import { AntdFormPropTypes, RoutingStorePropTypes } from '../../types/PropTypeValues';
      ...
      <Row type="flex" align="center" justify="center" style={{ height: '100vh' }}>
        <Col {...containerLayout} style={{ margin: 'auto 0' }}>
          ...
          <Form
            ...
            layout="horizontal"
          >
            {this.props.loading && <Spin tip="Регистрация..." spinning={this.props.loading} />}
            ...
            <Form.Item>
              <Row type="flex" justify="space-between">
                ...
                <Col sm={14} md={16} lg={18}>
                  <span style={{ textAlign: 'right' }}>Уже есть аккаунт? <Link to="/login">Войти</Link></span>
                </Col>
              </Row>
            </Form.Item>
          </Form>
