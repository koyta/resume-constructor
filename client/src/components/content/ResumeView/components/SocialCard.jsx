...
const SocialCard = (props) => {
  return (
    <div className="socials-card">
      <div className="socials-card-bg"><Icon type={props.type} /></div>
      <div className="socials-card-content">
        ...
        <footer className="socials-card-footer">
          <a className="socials-card-link" href={props.link}><Icon type="ie" />{props.link}</a>
          <div className="socials-card-bottom-line">
            <div className="socials-card-stats">
              <div className="socials-card-followers"><Icon type="heart" />{props.likes}</div>
              <div className="socials-card-stars"><Icon type="star" />{props.stars}</div>
            </div>
            <a className="socials-card-open" href={props.link}>OPEN</a>
          </div>
        </footer>
      </div>
    </div>
